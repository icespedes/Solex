...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		config = {
			...
			parallaxBackgroundImage: 'http://cdns.tblsft.com/sites/default/files/thumbnails/gartner_hp_slider.jpg', // CSS syntax, e.g. "a.jpg"

			// Parallax background size
			parallaxBackgroundSize: '2000px 900px', // CSS syntax, e.g. "3000px 2000px"
